      ...
      <div>
        <div className="flex flex-wrap mobile:gap-2 tablet:gap-2 gap-4 justify-center ">
          {bucketItems.map((item) => (
            <div
              key={item.id}
              className="bg-white shadow-md rounded-lg p-4 flex flex-col justify-between mobile:min-w-[160px] mobile:max-w-[160px] tablet:min-w-[300px] tablet:max-w-[300px] min-w-[300px] max-w-[300px] min-h-[160px] mb-4 hover:-translate-y-2 hover:transition-transform duration-300 cursor-pointer"
            >
              <div>
              ...
              <div className="flex justify-end gap-2">
                <button
                  className="bg-deep text-white text-xs rounded-full px-2 py-1 hover:-translate-y-1 transition-transform duration-300"
